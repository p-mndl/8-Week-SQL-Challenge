...
-- * monthly payments always occur on the same day of month as the original start_date of any
--   monthly paid plan
-- * upgrades from basic to monthly or pro plans are reduced by the current paid amount in that
--   month and start immediately
